...
export const updatePayment = async (codeBill, status) => {
    try {
...
export const createHistory = async (note, createdAt, codeBill, accountId, status) => {
    try {
...
export const plusBillDetail = async (codeBill, idBillDetail, idProduct) => {
...
export const subtractBillDetail = async (codeBill, idBillDetail, idProduct) => {
...
export const deleteBillDetail = async (codeBill, idBillDetail, idProduct) => {
