...
import { fetchBillDetailsAndPayments, updateBillStatusAndNote, createHistory } from '../../../Service/ApiBillDetailService';
                ...
                <tr key={item.tradingCode || item.productCode || `${item.productCode}-${index}`}>
                    ...
                    {type === "payment" ? (
                        <>
                            ...
                            <td className='text-center'>{item.namePayment == "Cash payment" ? "Thanh toán bằng tiền mặt" : ""}</td>
