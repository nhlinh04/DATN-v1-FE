...
import { createHistory } from '../../../../Service/ApiBillDetailService';
            ...
            if (response.status === 200 || response.status === 204) {
                ...
                try {
                    ...
                    if (account.status === 200) {
                        ...
                        await createHistory(`${account.data.email} đã cập nhật thông tin người dùng`, today, customerData.codeBill, account.data.id, 'ACTIVE');
                    }
                } catch (error) {
